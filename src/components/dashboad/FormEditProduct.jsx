      ...
      {props != [] && (
        <div>
          <form>
            ...
            <div class="form-group row">
              <label for="inputDesscription3" class="col-sm-2 col-form-label">
                Desscription
              </label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
                  id="inputDesscription"
                  placeholder={props.product.desscription}
                ></input>
              </div>
            </div>
            <div class="form-group row d-flex">
              <label for="selector-staff" class="col-sm-2 col-form-label">
                Category
              </label>
              <div class="col-sm-10">
                <select
          ...
          <div class="form-group row">
            <div class="col-sm-10">
              <button
                class="btn btn-primary back-content"
                onClick={() => handleFeature(props.type)}
              >
                Update Edit
              </button>
            </div>
